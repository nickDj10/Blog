<!-- UPDATE Post Data -->
  ...
  <?php
    ...
    if(isset($_POST['edit_post'])){
      ...
      $query = "UPDATE posts SET post_title = '$post_title', post_category_id = '$post_category_id', post_author = '$post_author', post_status = '$post_status', post_tags = '$post_tags', post_content = '$post_content', post_image = '$post_image' WHERE post_id = $post_id";
...
<!-- READ Post Data -->
  ...
  <form action="" method="POST" enctype="multipart/form-data"> 
    ...
    <!-- If User is Subscireber he will be not allowed to change the value, this is only for Admin -->
    <div class="form-group">
      <select name="post_status" id="">
          <option value="<?=$post_status?>"><?=ucfirst($post_status)?></option>
          <?php
