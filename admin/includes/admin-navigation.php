...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">   
            ...
            <li>
                <a href="comments.php"><i class="fa-solid fa-comment"></i>  Comments </a>
            </li>
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#second_collapse"><i class="fa-solid fa-users"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="second_collapse" class="collapse">
                    <li>
