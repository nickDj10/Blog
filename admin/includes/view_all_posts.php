      ...
      <tbody>
          ...
          ?>
              <tr>
                  ...
                  <td style="vertical-align: middle;"><a href="posts.php?publish=<?=$post_id?>"> Publish Post </a></td>
                  ...
                  <td style="vertical-align: middle;"><a href="posts.php?delete=<?=$post_id?>">Delete</a></td>
              </tr>
          <?php
