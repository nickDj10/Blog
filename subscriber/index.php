            ...
            <div class="container-fluid">
                ...
                <div class="row" >
                    ...
                    <h1 class="page-header">
                        <?=ucfirst($_SESSION['username'])?> / <small>Subscriber</small>
                        </h1>
                        ...
                        <?php
                            ...
                            if(isset($_POST['edit_user'])){
                              ...
                              $query = "UPDATE users SET user_firstname = '$user_firstname', user_lastname = '$user_lastname', user_name = '$user_name', user_email = '$user_email', user_password = '$user_password'  WHERE user_id = $user_id";
