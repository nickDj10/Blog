            ...
            <!-- Data download from User Search -->
               ...
               <?php
                  ...
                  if(isset($_POST["search_submit"])){
                     $user_search = mysqli_real_escape_string($connection,$_POST['search_input']);

                     if(!empty($user_search)){
                        $query = "SELECT * FROM posts WHERE post_tags LIKE '%$user_search%' AND post_status = 'published' ORDER BY post_id DESC";
